...
#define	OVERRIDE_PIN 0
#define OVERRIDE_PORT B
#define OVERRIDE_PORTOUT PORT(OVERRIDE_PORT)
#define OVERRIDE_DDR DDR(OVERRIDE_PORT)
#define OVERRIDE_PORTPIN PIN(OVERRIDE_PORT)
